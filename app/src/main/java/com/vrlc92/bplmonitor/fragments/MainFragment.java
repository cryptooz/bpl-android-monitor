...
import com.vrlc92.bplmonitor.models.Forging;
import com.vrlc92.bplmonitor.models.PeerVersion;
import com.vrlc92.bplmonitor.models.Settings;
import com.vrlc92.bplmonitor.models.Status;
import com.vrlc92.bplmonitor.models.Ticker;
import com.vrlc92.bplmonitor.services.ExchangeService;
            ...
            public void onResponse(final Delegate delegate) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String status = delegate.getRate() <= 201 ? getString(R.string.active) : getString(R.string.standby);
